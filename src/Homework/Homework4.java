...
public class Homework4 {
    public static void main(String[] args) {
        ...
        movie2.setMovieDetail(2,
                ...
                "A prequel to The Lion King, this film explores the origins of Mufasa, revealing his journey from an orphaned cub to the powerful king of the Pride Lands. With friendships, rivalries, and destiny shaping his path, the story unveils the legend behind the lion.",
                "TBA",
        ...
        movie3.setMovieDetail(3,
                UUID.randomUUID().toString(),
                "Jaws (1975)",
                "A quiet beach town is terrorized by a massive great white shark. As panic spreads, a police chief, a marine biologist, and a grizzled shark hunter set out to stop the deadly creature before it strikes again.",
                "2 hours 4 minutes",
